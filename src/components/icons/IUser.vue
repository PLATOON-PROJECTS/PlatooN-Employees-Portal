<template>
    <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path
            ...
            stroke="#222222" stroke-opacity="0.24" stroke-width="1.5" stroke-miterlimit="10" />
        <path
            ...
            stroke="#222222" stroke-opacity="0.24" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
    </svg>
