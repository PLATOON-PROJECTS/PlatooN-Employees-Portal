<template>
    <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path
            ...
            stroke="#626669" stroke-width="1.3" stroke-linecap="round" stroke-linejoin="round" />
        <path
            ...
            stroke="#626669" stroke-width="1.3" stroke-linecap="round" stroke-linejoin="round" />
        <path d="M10 9.0625V13.4375" stroke="#626669" stroke-width="1.3" stroke-linecap="round"
            stroke-linejoin="round" />
        <path d="M12.1875 11.25H7.8125" stroke="#626669" stroke-width="1.3" stroke-linecap="round"
            stroke-linejoin="round" />
    </svg>
